			...
			appendStickyMenu: function() {
                if (!document.getElementById('stickingMenu')) {
                    var newEl = document.createElement('div'),
                        ...
                        clone = Array.prototype.filter.call(document.querySelectorAll('div table th span'), 
							function(i){
								return i['innerHTML'] ? i['innerHTML'].match(/Induction Specific Backlog Formation for Technical Analyst Competency Model/gi) : i['innerText'].match(/Induction Specific Backglog Formation for Technical Analyst Competency Model/gi);
							})[0].cloneNode(1);
...
config.domReady(function() {
	config.instance = new config.animationConstruct([Array.prototype.filter.call(document.querySelectorAll('div a'), 
							function(i){
								return i.text.match(/R&D Technical Analyst:/gi);
							})[0].parentNode.nextElementSibling], Array.prototype.filter.call(document.querySelectorAll('div[style] a[style*="small-caps"]:not([href])'), function(i){return i.text.match(/Functional Competencies: Technical Analyst/gi);})[0]);
